...
//-------------------------------------------------------------------------------------------------------
{
    ...
    //---------------------------------------------------------------------------------------------------
    CreateTrans(userId2, transId, members, [NSString stringWithFormat:@"%@_%@", user[PF_USER_FULLNAME], translator[PF_USER_FULLNAME]], userId1, @"private");
    //---------------------------------------------------------------------------------------------------
    return transId;
}
...
//-------------------------------------------------------------------------------------------------------
{
    ...
    //---------------------------------------------------------------------------------------------------
    //TODO: change createRecents
    if ([recent[@"type"] isEqualToString:@"multiple"])
    {
        CreateRecents(recent[@"transId"], recent[@"members"], recent[@"description"], recent[@"profileId"], @"multiple");
    }
    //---------------------------------------------------------------------------------------------------
    if ([recent[@"type"] isEqualToString:@"group"])
    {
        CreateRecents(recent[@"transId"], recent[@"members"], recent[@"description"], recent[@"profileId"], @"group");
    }
}
