...
#define		TRANS_STATUS_TRANSLATOR_FOUND       @"translator_found"
#define		TRANS_STATUS_ACCEPTED               @"accepted"
#define		TRANS_STATUS_ENDED                  @"ended"
#define		TRANS_STATUS_EXPIRED                @"expired"

#define		APP_TRANS_STATUS_LIMBO               -1
#define		APP_TRANS_STATUS_IDLE                0
#define		APP_TRANS_STATUS_REQYESTED           1
#define		APP_TRANS_STATUS_TRANSLATOR_FOUND    2
#define		APP_TRANS_STATUS_ONGOING             3
