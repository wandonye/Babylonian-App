...
void            CreateTrans             (NSString *userId, NSString *transId, NSArray *members, NSString *description,
                                         NSString *profileId, NSString *type);
void            CreateTransItem         (NSString *userId, NSString *transId, NSArray *members, NSString *description,
                                         NSString *profileId, NSString *type);
