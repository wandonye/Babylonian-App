//
// Copyright (c) 2015 Dongning Wang
...
{
    self.groupId = groupId_;
    self.firebase1 = [[Firebase alloc] initWithUrl:[NSString stringWithFormat:@"%@/Message/%@", FIREBASE, self.groupId]];
}
//-------------------------------------------------------------------------------------------------------------------------------------------------
- (void)viewDidLoad
//-------------------------------------------------------------------------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	...
	{
		ClearRecentCounter(self.groupId);
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	Incoming *incoming = [[Incoming alloc] initWith:self.groupId CollectionView:self.collectionView];
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	Outgoing *outgoing = [[Outgoing alloc] initWith:self.groupId View:self.navigationController.view];
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	...
	NSArray *menuItems = @[[[RNGridMenuItem alloc] initWithImage:[UIImage imageNamed:@"chat_location"]
                                title:@"Location"],
