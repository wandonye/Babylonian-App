...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
    ...
    NavigationController *navController3 = [[NavigationController alloc] initWithRootViewController:self.leaderboardView];
	...
	self.tabBarController.viewControllers = @[navController2, navController3, navController4, navController5];
